...
<body>
    ...
    <section id="create" class="content">
        ...
        <form action="includes/insert.php" method="POST">
            ...
            <div class="google-input">
                <input type="text" name="middlename" id="middlename" class="field" placeholder=" " required>
                <label for="middlename" class="label">Middle name</label>
            </div>

            <div class="google-input">
                <input type="text" name="address" id="address" class="field" placeholder=" " required>
                <label for="address" class="label">Address</label>
            </div>

            <div class="google-input">
                <input type="number" name="contact_number" id="contact_number" class="field" placeholder=" " required>
